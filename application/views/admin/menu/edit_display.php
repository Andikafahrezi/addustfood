<div class="conatiner">
    <form id="myForm" action="<?php echo base_url().'admin/menu/edit_display/'.$dish['di_id'];?>" method="POST"
            ...
            <select name="rname" id="resname"
                ...
                if (!empty($stores)) { 
                    foreach($stores as $store) {
                        ?>
                <option value="<?php echo $store['di_id'];?>">
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    ...
                    <?php echo (form_error('price') != "") ? 'is-invalid' : '';?>" id="price" name="price"
                        placeholder="Masukkan Harga Rp." value="<?php echo set_value('price', $dish['price']); ?>">
                    <span></span>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <label for="about">Ket</label>
                    <input type="text" class="form-control my-2
                    <?php echo (form_error('about') != "") ? 'is-invalid' : '';?>" id="about" name="about"
                        placeholder="Ket" value="<?php echo set_value('about', $dish['about']); ?>">
                    <span></span>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <?php if($dish['image'] != "" && file_exists('./public/uploads/dishesh/display/'.$dish['image'])) { ?>

                    <img src="<?php echo base_url().'public/uploads/dishesh/display/'.$dish['image'];?>">
        ...
        <a href="<?php echo base_url().'admin/menu/indexd'?>" class="btn btn-secondary">Back</a>
    </form>
</div>
<script>
