        ...
        <div class="table-responsive-sm">
            <table class="table table-bordered table-hover table-striped table-responsive">
                ...
                <tbody id="myTable">
                    ...
                    <tr>
                        <td><?php echo $dish['di_id']; ?></td>
                        <td><?php echo $dish['name']; ?></td>
                        <td><?php echo $dish['about']; ?></td>
                        <td><?php echo "Rp".$dish['price']; ?></td>
                        <td>
                            <a href="<?php echo base_url().'admin/menu/edit_display/'.$dish['di_id']; ?>"
                                class="btn btn-info mb-1"><i
                                    class="fas fa-edit mr-1"></i>Edit</a>

                            <a href="javascript:void(0);" onclick="deleteDisplay(<?php echo $dish['di_id']; ?>)"
...
function deleteDisplay(id) {
    if (confirm("Are you sure you want to delete dish?")) {
        window.location.href = '<?php echo base_url().'admin/menu/delete_display/';?>' + id;
    }
}
